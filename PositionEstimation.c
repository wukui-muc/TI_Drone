...
const float KalmanFilter_Unit[5][7] =
{  //Q_Position      Q_Velocity      Q_Bias         R_Position     AxisC_0    AxisPP        Merge_t
...
//     {   0.005,           0.001,        0.001,          0.4,            1,         1.0,         0.005  },//Barometer
     {   0.05,            0.05,         0.045,          0.04,           1,         1.0,         0.005 },//car_x
     {   0.05,            0.05,         0.045,          0.04,           1,         1.0,         0.005 },//car_y
};
 ...
 *
 */
void KalmanFilter_Init(KalmanFilter *XAXIS,KalmanFilter *YAXIS,KalmanFilter *ZAXIS ,KalmanFilter *CARX,KalmanFilter *CARY){
...
//    BAROMETER->Merge_t = KalmanFilter_Unit[3][6];
    ...
    CARX->Q_Position = KalmanFilter_Unit[3][0];
    CARX->Q_Velocity = KalmanFilter_Unit[3][1];
    CARX->Q_Bias = KalmanFilter_Unit[3][2];
    CARX->R_Position = KalmanFilter_Unit[3][3];
    CARX->AxisC_0 = KalmanFilter_Unit[3][4];
    CARX->AxisPP[0][0] = KalmanFilter_Unit[3][5];
    CARX->AxisPP[1][1] = KalmanFilter_Unit[3][5];
    CARX->AxisPP[2][2] = KalmanFilter_Unit[3][5];
    CARX->Merge_t = KalmanFilter_Unit[3][6];

    CARY->Q_Position = KalmanFilter_Unit[4][0];
    CARY->Q_Velocity = KalmanFilter_Unit[4][1];
    CARY->Q_Bias = KalmanFilter_Unit[4][2];
    CARY->R_Position = KalmanFilter_Unit[4][3];
    CARY->AxisC_0 = KalmanFilter_Unit[4][4];
    CARY->AxisPP[0][0] = KalmanFilter_Unit[4][5];
    CARY->AxisPP[1][1] = KalmanFilter_Unit[4][5];
    CARY->AxisPP[2][2] = KalmanFilter_Unit[4][5];
    CARY->Merge_t = KalmanFilter_Unit[4][6];
}
