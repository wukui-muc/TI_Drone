...
void Load_ParaConfig(void){
    ...
    if(flashData.isGood==0xA55A)
    {
        ...
        OffsetData.AccX = flashData.Offset_Data.AccX =0.287207991;
        OffsetData.AccY = flashData.Offset_Data.AccY =0.0775171891;
        OffsetData.AccZ = flashData.Offset_Data.AccZ =0.452744901;

        OffsetData.AccXScale = flashData.Offset_Data.AccXScale =0.998396575;
        OffsetData.AccYScale = flashData.Offset_Data.AccYScale =1;
        OffsetData.AccZScale = flashData.Offset_Data.AccZScale =0.9831;
